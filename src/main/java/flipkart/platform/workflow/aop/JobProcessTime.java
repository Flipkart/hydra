package flipkart.platform.workflow.aop;
...
import flipkart.platform.workflow.node.workstation.WorkStation;
...
public class JobProcessTime
{
        ...
        Throwable
    {
        ...
        final String type = annotation.type().isEmpty() ? worker.name : annotation.type();
