 ...
 * Date: 05/08/12
 */
public class HttpNodeBuilder<I, O> extends AbstractNodeBuilder<I, O>
{
    ...
    public static <I,O> HttpNodeBuilder<I, O> with(Class<? extends HttpJob<I, O>> httpJob) throws NoSuchMethodException
    {
        return withHttpJob(httpJob.getSimpleName(), DefaultJobFactory.create(httpJob));
    }

    private static <I, O> HttpNodeBuilder<I, O> withHttpJob(String name, JobFactory<? extends HttpJob<I, O>> jobFactory)
    {
